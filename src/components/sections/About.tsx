...
export function About() {
  return (
    <section id="om-age" className="py-20 sm:py-24 bg-[#f8f6f2]">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
          ...
          <AnimateOnScroll>
            <div>
              ...
              <h2 className="font-display text-3xl font-bold text-[#1a2b1a] sm:text-4xl mb-4">
                Åge Vik
              </h2>

              {/* Credential badges */}
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-[#1e6ec8]/30 bg-[#1e6ec8]/8 px-3 py-1.5 text-xs font-semibold text-[#1e6ec8]">
                  <Award className="h-3.5 w-3.5" />
                  Mesterbrev i tømrerfaget
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-full border border-[#2d6b2e]/30 bg-[#2d6b2e]/8 px-3 py-1.5 text-xs font-semibold text-[#1e6ec8]">
                  <ShieldCheck className="h-3.5 w-3.5" />
                  5 års garanti på utført arbeid
                </span>
              </div>
              <p className="text-[#5a6e5a] leading-relaxed mb-4">
              ...
              <p className="text-[#5a6e5a] leading-relaxed mb-8">
              ...
              <div className="flex flex-col gap-4">
                {values.map((v) => (
                  <div key={v.label} className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-[#1e6ec8] shrink-0 mt-0.5" />
                    <div>
                      <p className="font-semibold text-[#1a2b1a] text-sm">{v.label}</p>
                      <p className="text-xs text-[#5a6e5a]">{v.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {/* Visual side – real photo of Åge */}
          <AnimateOnScroll delay={1}>
            <div className="relative">
              {/* Main photo */}
              <div className="overflow-hidden rounded-2xl border border-[#cce0cc] shadow-[var(--shadow-card)]">
                <Image
              ...
              {/* Stats overlay card */}
              <div className="absolute -bottom-6 -right-4 sm:-right-6 rounded-xl border border-[#cce0cc] bg-white shadow-[var(--shadow-hover)] p-4 grid grid-cols-3 gap-x-5 gap-y-2">
                <div className="text-center">
                  <p className="font-display text-2xl font-bold text-[#1e6ec8]">20+</p>
                  <p className="text-xs text-[#5a6e5a]">År erfaring</p>
                </div>
                <div className="text-center">
                  <p className="font-display text-2xl font-bold text-[#1e6ec8]">100%</p>
                  <p className="text-xs text-[#5a6e5a]">Anbefalt</p>
                </div>
                <div className="text-center">
                  <p className="font-display text-xl font-bold text-[#1e6ec8]">Mester</p>
                  <p className="text-xs text-[#5a6e5a]">Fagbrev</p>
                </div>
              </div>

              {/* Decorative green gradient */}
              <div className="absolute -inset-4 rounded-3xl bg-[#2d6b2e]/5 blur-xl -z-10" />
            </div>
          </AnimateOnScroll>
        </div>
      </div>
